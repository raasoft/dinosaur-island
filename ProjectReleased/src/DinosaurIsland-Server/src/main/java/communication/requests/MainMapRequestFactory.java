 ...
 *
 */
final public class MainMapRequestFactory extends RequestFactory {

	static final MainMapRequestFactory uniqueInstance = new MainMapRequestFactory();
	
	private MainMapRequestFactory() {
		super();
	}
	
	public MainMapRequest createRequest(ArrayList<String> theTokens, SocketClientHandler socketClientHandler) throws IllegalArgumentException {
		...
		return new MainMapRequest(token, socketClientHandler);
	}
	
	public static MainMapRequestFactory getInstance() {
	...
	public void setupLogger() {
		logger = Logger.getLogger("server.commandfactory.requestfactory.generalmaprequestfactory");
	...
	protected void populateValidCommandTags() {
		validCommandTags.add("@mappaGenerale");		
	}

 ...
 *
 */
public class EnterGameRequestFactory extends RequestFactory {

	static final EnterGameRequestFactory uniqueInstance = new EnterGameRequestFactory();
	
	private EnterGameRequestFactory() {
		super();
	}
	
	public EnterGameRequest createRequest(ArrayList<String> theTokens, SocketClientHandler socketClientHandler) throws IllegalArgumentException {
		...
		return new EnterGameRequest(token, socketClientHandler);
	}
	
	public static EnterGameRequestFactory getInstance() {
	...
	public void setupLogger() {
		logger = Logger.getLogger("server.commandfactory.requestfactory.entergamerequestfactory");
	...
	protected void populateValidCommandTags() {
		validCommandTags.add("@accessoPartita");		
	}

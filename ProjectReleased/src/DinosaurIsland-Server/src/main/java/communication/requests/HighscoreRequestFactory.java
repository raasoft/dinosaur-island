 ...
 *
 */
public class HighscoreRequestFactory extends RequestFactory {

	static final HighscoreRequestFactory uniqueInstance = new HighscoreRequestFactory();
	
	private HighscoreRequestFactory() {
		super();
	}
	
	public HighscoreRequest createRequest(ArrayList<String> theTokens, SocketClientHandler socketClientHandler) throws IllegalArgumentException {
		...
		return new HighscoreRequest(token, socketClientHandler);
	}
	
	public static HighscoreRequestFactory getInstance() {
	...
	public void setupLogger() {
		logger = Logger.getLogger("server.commandfactory.requestFactory.highscoreRequestFactory");
	...
	protected void populateValidCommandTags() {
		validCommandTags.add("@classifica");		
	}

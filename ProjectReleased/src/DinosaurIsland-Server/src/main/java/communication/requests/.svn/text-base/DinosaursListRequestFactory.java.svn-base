 ...
 *
 */
public class DinosaursListRequestFactory extends RequestFactory {

	static final DinosaursListRequestFactory uniqueInstance = new DinosaursListRequestFactory();
	
	private DinosaursListRequestFactory() {
		super();
	}
	
	public DinosaursListRequest createRequest(ArrayList<String> theTokens, SocketClientHandler socketClientHandler) throws IllegalArgumentException {
		...
		return new DinosaursListRequest(token, socketClientHandler);
	}
	
	public static DinosaursListRequestFactory getInstance() {
	...
	public void setupLogger() {
		logger = Logger.getLogger("server.commandfactory.requestFactory.dinosaursListRequestsFactory");
	...
	protected void populateValidCommandTags() {
		validCommandTags.add("@listaDinosauri");		
	}

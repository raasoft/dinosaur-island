 ...
 *
 */
public class PlayersListRequestFactory extends RequestFactory {

	static final PlayersListRequestFactory uniqueInstance = new PlayersListRequestFactory();
	
	private PlayersListRequestFactory() {
		super();
	}
	
	public PlayersListRequest createRequest(ArrayList<String> theTokens, SocketClientHandler socketClientHandler) throws IllegalArgumentException {
		...
		return new PlayersListRequest(token, socketClientHandler);
	}
	
	public static PlayersListRequestFactory getInstance() {
	...
	public void setupLogger() {
		logger = Logger.getLogger("server.commandfactory.requestfactory.playerslistrequestfactory");
	...
	protected void populateValidCommandTags() {
		validCommandTags.add("@listaGiocatori");		
	}

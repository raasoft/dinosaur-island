 ...
 *
 */
public class LogoutResponseFactory extends ResponseFactory {
	
	static final LogoutResponseFactory uniqueInstance = new LogoutResponseFactory();

	public static LogoutResponseFactory getInstance() {
	...
	public LogoutResponse createResponse(String theStringToBeParsed) throws IllegalArgumentException {
		...
		return new LogoutResponse(getResponsePositivity(), invalidTokenFlag);
	}
	...
	public void setupLogger() {
		logger = Logger.getLogger("client.responseFactory.logoutResponseFactory");
